...
모양 다섯 가지에 색 프리셋을 더해 **모두 31종**입니다. 그림에서 세로줄은 모양(염소·양·새·개구리·돼지)이고,
...
**원본을 그대로 쓰지 않고 색을 바꿔 표시합니다.** 받은 그림 아홉 장은 그대로 두고,
등·배·눈 같은 부위를 따로 칠해 모양마다 프리셋을 여섯에서 일곱 개씩 만들었습니다.
